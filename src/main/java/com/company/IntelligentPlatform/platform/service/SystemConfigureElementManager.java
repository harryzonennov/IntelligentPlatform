...
import com.company.IntelligentPlatform.platform.dto.ISystemConfigureSwitch;
...
public class SystemConfigureElementManager {
	...
	public List<PageHeaderModel> getPageHeaderModelList(SimpleSEJSONRequest request, String client)
		...
		docPageHeaderInputPara.setGenBaseModelList(new DocPageHeaderModelProxy.GenBaseModelList<SystemConfigureResource>() {
			@Override
			public List<com.company.IntelligentPlatform.platform.controller.PageHeaderModel> execute(SystemConfigureResource systemConfigureResource) throws ServiceEntityConfigureException {
		...
		docPageHeaderInputPara.setGenHomePageModel(new DocPageHeaderModelProxy.GenHomePageModel<SystemConfigureElement>() {
			@Override
			public com.company.IntelligentPlatform.platform.controller.PageHeaderModel execute(SystemConfigureElement systemConfigureElement, com.company.IntelligentPlatform.platform.controller.PageHeaderModel pageHeaderModel) throws ServiceEntityConfigureException {
