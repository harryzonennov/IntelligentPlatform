...
import com.company.IntelligentPlatform.platform.dto.AuthorizationGroupUIModel;
import jakarta.persistence.EntityManager;
import jakarta.persistence.PersistenceContext;
import com.company.IntelligentPlatform.platform.repository.AuthorizationGroupRepository;
import com.company.IntelligentPlatform.platform.service.JpaServiceEntityDAO;
import com.company.IntelligentPlatform.platform.service.SystemMandatoryModeProxy;
...
import com.company.IntelligentPlatform.platform.model.AuthorizationGroupConfigureProxy;
...
public class AuthorizationGroupManager extends ServiceEntityManager {
	...
	public void setServiceEntityDAO() {
		...
		super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, authorizationGroupDAO, this.getSeConfigureProxy()));
	}
