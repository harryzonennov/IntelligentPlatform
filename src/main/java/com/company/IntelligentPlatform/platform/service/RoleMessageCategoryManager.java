...
import com.company.IntelligentPlatform.platform.dto.RoleMessageCategoryUIModel;
...
import com.company.IntelligentPlatform.platform.service.ServiceSearchProxyRepository;
...
public class RoleMessageCategoryManager {
    ...
    public List<PageHeaderModel> getPageHeaderModelList(SimpleSEJSONRequest request, String client)
        ...
        docPageHeaderInputPara.setGenBaseModelList(new DocPageHeaderModelProxy.GenBaseModelList<Role>() {
            @Override
            public List<com.company.IntelligentPlatform.platform.controller.PageHeaderModel> execute(Role role) throws ServiceEntityConfigureException {
        ...
        docPageHeaderInputPara.setGenHomePageModel(new DocPageHeaderModelProxy.GenHomePageModel<RoleMessageCategory>() {
            @Override
            public com.company.IntelligentPlatform.platform.controller.PageHeaderModel execute(RoleMessageCategory roleMessageCategory, com.company.IntelligentPlatform.platform.controller.PageHeaderModel pageHeaderModel) throws ServiceEntityConfigureException {
