...
import com.company.IntelligentPlatform.platform.dto.ServiceEntityRegisterEntitySearchModel;
import com.company.IntelligentPlatform.platform.dto.ServiceEntityRegisterEntityUIModel;
import jakarta.persistence.EntityManager;
import jakarta.persistence.PersistenceContext;
import com.company.IntelligentPlatform.platform.repository.ServiceEntityRegisterEntityRepository;
...
import com.company.IntelligentPlatform.platform.model.ServiceEntityRegisterEntityConfigureProxy;
...
public class ServiceEntityRegisterEntityManager extends ServiceEntityManager {
    ...
    public ServiceEntityRegisterEntityManager() {
        super.seConfigureProxy = new ServiceEntityRegisterEntityConfigureProxy();
    }

    @PostConstruct
    public void setServiceEntityDAO() {
        super.setSeConfigureProxy(serviceEntityRegisterEntityConfigureProxy);
        super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, serviceEntityRegisterEntityDAO, this.getSeConfigureProxy()));
    }
