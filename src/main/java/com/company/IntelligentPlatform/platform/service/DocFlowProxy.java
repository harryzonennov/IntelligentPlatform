...
import com.company.IntelligentPlatform.platform.dto.BasicDocItemInitModel;
...
import static com.company.IntelligentPlatform.platform.service.StandardDocFlowDirectionProxy.*;
		...
		if (documentContent != null && documentUIModel != null) {
			...
			if (documentContent.getCreatedTime() != null) {
				documentUIModel.setCreatedDate(
						DefaultDateFormatConstant.formatDate(documentContent.getCreatedTime()));
				documentUIModel.setCreatedTime(
						DefaultDateFormatConstant.formatDateMin(documentContent.getCreatedTime()));
			}
			if (documentContent.getLastUpdateTime() != null) {
				documentUIModel.setUpdatedDate(
						DefaultDateFormatConstant.formatDate(documentContent.getLastUpdateTime()));
				documentUIModel.setUpdatedTime(
						DefaultDateFormatConstant.formatDateMin(documentContent.getLastUpdateTime()));
			}
		}
	}
	...
	public static void convServiceEntityNodeToUIModel(ServiceEntityNode serviceEntityNode, SEUIComModel uiModel) {
		...
		if (serviceEntityNode.getCreatedTime() != null) {
			uiModel.setCreatedDate(
					DefaultDateFormatConstant.formatDate(serviceEntityNode.getCreatedTime()));
			uiModel.setCreatedTime(
					DefaultDateFormatConstant.formatDateMin(serviceEntityNode.getCreatedTime()));
		}
		if (serviceEntityNode.getLastUpdateTime() != null) {
			uiModel.setUpdatedDate(
					DefaultDateFormatConstant.formatDate(serviceEntityNode.getLastUpdateTime()));
			uiModel.setUpdatedTime(
					DefaultDateFormatConstant.formatDateMin(serviceEntityNode.getLastUpdateTime()));
		}
		...
		if (docMatItemNode != null && docMatItemUIModel != null) {
			...
			if (docMatItemNode.getCreatedTime() != null) {
				docMatItemUIModel.setCreatedDate(
						DefaultDateFormatConstant.formatDate(docMatItemNode.getCreatedTime()));
				docMatItemUIModel.setCreatedTime(
						DefaultDateFormatConstant.formatDateMin(docMatItemNode.getCreatedTime()));
			}
			...
			if (docMatItemNode.getLastUpdateTime() != null) {
				docMatItemUIModel.setUpdatedDate(
						DefaultDateFormatConstant.formatDate(docMatItemNode.getLastUpdateTime()));
				docMatItemUIModel.setUpdatedTime(
						DefaultDateFormatConstant.formatDateMin(docMatItemNode.getLastUpdateTime()));
			}
