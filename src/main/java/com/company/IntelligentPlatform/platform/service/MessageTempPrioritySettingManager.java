...
import com.company.IntelligentPlatform.platform.dto.MessageTempPrioritySettingUIModel;
...
public class MessageTempPrioritySettingManager {
    ...
    public List<PageHeaderModel> getPageHeaderModelList(SimpleSEJSONRequest request, String client)
        ...
        docPageHeaderInputPara.setGenBaseModelList(new DocPageHeaderModelProxy.GenBaseModelList<MessageTemplate>() {
            @Override
            public List<com.company.IntelligentPlatform.platform.controller.PageHeaderModel> execute(MessageTemplate messageTemplate) throws ServiceEntityConfigureException {
        ...
        docPageHeaderInputPara.setGenHomePageModel(new DocPageHeaderModelProxy.GenHomePageModel<MessageTempPrioritySetting>() {
            @Override
            public com.company.IntelligentPlatform.platform.controller.PageHeaderModel execute(MessageTempPrioritySetting messageTemplateMaterialItem, com.company.IntelligentPlatform.platform.controller.PageHeaderModel pageHeaderModel) throws ServiceEntityConfigureException {
