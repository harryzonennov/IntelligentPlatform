...
import com.company.IntelligentPlatform.platform.service.ServiceExtensionException;
...
import com.company.IntelligentPlatform.platform.model.AttachmentConstantHelper;
import com.company.IntelligentPlatform.platform.model.DefaultDateFormatConstant;
import com.company.IntelligentPlatform.platform.model.SelectMapModel;
...
import com.company.IntelligentPlatform.platform.model.ServiceEntityPersistenceHelper;
        ...
        for (int i = 0; i < seConfigureProxy.getSeConfigMapList().size(); i++) {
            ...
            if (seConfigureMap.getNodeName().equals(
                ...
                try {
                    ...
                    rootNode.setUuid(java.util.UUID.randomUUID().toString());
