...
import com.company.IntelligentPlatform.platform.model.LogonUserConfigureProxy;
...
public class LogonUserManager extends ServiceEntityManager {
	...
	public LogonUserManager() {
		super.seConfigureProxy = new LogonUserConfigureProxy();
	}
	...
	public void setServiceEntityDAO() {
		...
		super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, logonUserDAO, this.getSeConfigureProxy()));
	}
