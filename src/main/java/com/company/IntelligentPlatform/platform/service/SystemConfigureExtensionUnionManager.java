...
public class SystemConfigureExtensionUnionManager {
	...
	public List<PageHeaderModel> getPageHeaderModelList(SimpleSEJSONRequest request, String client)
		...
		docPageHeaderInputPara.setGenHomePageModel(new DocPageHeaderModelProxy.GenHomePageModel<SystemConfigureExtensionUnion>() {
			@Override
			public com.company.IntelligentPlatform.platform.controller.PageHeaderModel execute(SystemConfigureExtensionUnion systemConfigureExtensionUnion, com.company.IntelligentPlatform.platform.controller.PageHeaderModel pageHeaderModel) throws ServiceEntityConfigureException {
