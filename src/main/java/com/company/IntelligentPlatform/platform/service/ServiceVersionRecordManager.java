...
import com.company.IntelligentPlatform.platform.repository.ServiceVersionRecordRepository;
...
import com.company.IntelligentPlatform.platform.model.ServiceVersionRecord;
import com.company.IntelligentPlatform.platform.model.ServiceVersionRecordConfigureProxy;
...
public class ServiceVersionRecordManager extends ServiceEntityManager {
    ...
    public void setServiceEntityDAO() {
        ...
        super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, serviceVersionRecordDAO, this.getSeConfigureProxy()));
    }
