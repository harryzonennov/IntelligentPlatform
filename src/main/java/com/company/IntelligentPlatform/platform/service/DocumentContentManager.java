...
import com.company.IntelligentPlatform.platform.model.DocumentContentConfigureProxy;
...
public class DocumentContentManager extends ServiceEntityManager {
	...
	public void setServiceEntityDAO() {
		...
		super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, documentContentDAO, this.getSeConfigureProxy()));
	}
}
