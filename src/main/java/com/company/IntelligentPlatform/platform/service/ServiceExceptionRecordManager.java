...
import com.company.IntelligentPlatform.platform.repository.ServiceExceptionRecordRepository;
...
import com.company.IntelligentPlatform.platform.model.ServiceExceptionRecordConfigureProxy;
...
public class ServiceExceptionRecordManager extends ServiceEntityManager {
    ...
    public void setServiceEntityDAO() {
        ...
        super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, serviceExceptionRecordDAO, this.getSeConfigureProxy()));
    }
