...
public interface IBootStrapTreeModelConstants {
	...
	String BADGE_IMPORTANT = "badge-important";
	
	String BADGE_SUCCESS = "badge-success";
	
	String BADGE_LIGHTGREY = "badge-lightGrey";
	
	String BADGE_WARNING = "badge-warning";
	
	String BADGE_ORGANIZATION = "badge-organization";
