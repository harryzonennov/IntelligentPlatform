...
import com.company.IntelligentPlatform.platform.model.CorporateCustomerAttachment;
import com.company.IntelligentPlatform.platform.model.CustomerParentOrgReference;
import com.company.IntelligentPlatform.platform.model.ServiceEntityConfigureException;

@Service
public class CorporateSupplierServiceUIModelExtension extends
	...
	public List<ServiceUIModelExtensionUnion> genUIModelExtensionUnion() {
		...
		Class<?>[] corporateCustomerConvToUIParas = { CorporateCustomer.class,
				CorporateSupplierUIModel.class };
		corporateCustomerMap
				.setConvToUIMethodParas(corporateCustomerConvToUIParas);
		corporateCustomerMap
				.setConvToUIMethod(CorporateSupplierManager.METHOD_ConvCorporateCustomerToSupplierUI);
		Class<?>[] CorporateCustomerConvUIToParas = {
				CorporateSupplierUIModel.class, CorporateCustomer.class };
		corporateCustomerMap
				.setConvUIToMethodParas(CorporateCustomerConvUIToParas);
		corporateCustomerMap.setLogicManager(corporateSupplierManager);
		corporateCustomerMap
				.setConvUIToMethod(CorporateSupplierManager.METHOD_ConvSupplierUIToCorporateCustomer);
		...
		customerParentOrgReferenceMap
				.setConvUIToMethod(CorporateCustomerManager.METHOD_ConvSupplierUIToCustomerParentOrgReference);
