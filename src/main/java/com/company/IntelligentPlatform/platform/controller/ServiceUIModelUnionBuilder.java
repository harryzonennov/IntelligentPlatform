...
public class ServiceUIModelUnionBuilder {
    ...
    public ServiceUIModelUnionBuilder serviceEntityManager(ServiceEntityManager serviceEntityManager) {
    ...
    public ServiceUIModelExtensionUnion build() throws ServiceEntityConfigureException {
        ...
        serviceUIModelExtensionUnion.setServiceEntityManager(getServiceEntityManager());
