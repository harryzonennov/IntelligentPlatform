...
public class DocUIModelExtensionBuilder {
    ...
    private ServiceUIModelUnionBuilder buildExtensionHeader(String paraGroupId) throws DocActionException {
        try {
            ...
            if (builderParaGroup.getLogicManager() instanceof com.company.IntelligentPlatform.platform.service.ServiceEntityManager) {
                docServiceUIModelUnionBuilder.serviceEntityManager(
                        (com.company.IntelligentPlatform.platform.service.ServiceEntityManager) builderParaGroup.getLogicManager());
            }
