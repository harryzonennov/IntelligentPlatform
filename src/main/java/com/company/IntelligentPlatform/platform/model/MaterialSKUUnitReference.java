...
@Entity
@Table(name = "MaterialSKUUnitReference", catalog = "platform")
public class MaterialSKUUnitReference extends ReferenceNode {

	public static final String NODENAME = IServiceModelConstants.MaterialSKUUnitReference;
	...
	public MaterialSKUUnitReference() {
		super.serviceEntityName = SENAME;
		super.nodeName = NODENAME;
		this.unitType = UNITTYPE_REF_TOSTANDARD;
