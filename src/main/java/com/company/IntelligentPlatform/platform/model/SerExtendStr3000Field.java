...
@Entity
@Table(name = "SerExtendStr3000Field", catalog = "platform")
public class SerExtendStr3000Field extends ReferenceNode{
	
	public static final String NODENAME = IServiceModelConstants.SerExtendStr3000Field;

	public static final String SENAME = IServiceModelConstants.ServiceExtensionSetting;
	
	public SerExtendStr3000Field() {
