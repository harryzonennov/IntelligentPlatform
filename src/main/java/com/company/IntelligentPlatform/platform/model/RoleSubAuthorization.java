...
@Entity
@Table(name = "RoleSubAuthorization", catalog = "platform")
public class RoleSubAuthorization extends ReferenceNode {

	public static final String NODENAME = IServiceModelConstants.RoleSubAuthorization;
	...
	public RoleSubAuthorization() {
		this.nodeName = NODENAME;
		this.serviceEntityName = SENAME;
		this.processType = PROCESSTYPE_PARALLEL; // default process type for system type AO
