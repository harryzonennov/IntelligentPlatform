...
@Entity
@Table(name = "CorporateCustomerActionNode", catalog = "platform")
public class CorporateCustomerActionNode extends DocActionNode {

	public static final String NODENAME = IServiceModelConstants.CorporateCustomerActionNode;
	...
	public CorporateCustomerActionNode() {
