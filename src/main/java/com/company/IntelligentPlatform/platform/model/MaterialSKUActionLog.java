...
@Entity
@Table(name = "MaterialSKUActionLog", catalog = "platform")
public class MaterialSKUActionLog extends DocActionNode {

	public static final String NODENAME = IServiceModelConstants.MaterialSKUActionLog;
