...
@Entity
@Table(name = "MaterialActionLog", catalog = "platform")
public class MaterialActionLog extends DocActionNode {

	public static final String NODENAME = IServiceModelConstants.MaterialActionLog;
