...
@Entity
@Table(name = "SerExtendPageSettingActionNode", catalog = "platform")
public class SerExtendPageSettingActionNode extends DocActionNode {

	public static final String NODENAME = IServiceModelConstants.SerExtendPageSettingActionNode;
	...
	public SerExtendPageSettingActionNode() {
