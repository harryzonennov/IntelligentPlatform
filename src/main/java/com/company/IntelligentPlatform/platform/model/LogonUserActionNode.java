...
@Entity
@Table(name = "LogonUserActionNode", catalog = "platform")
public class LogonUserActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.LogonUserActionNode;
