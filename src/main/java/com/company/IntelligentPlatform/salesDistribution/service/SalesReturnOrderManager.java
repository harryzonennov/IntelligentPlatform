...
import com.company.IntelligentPlatform.salesDistribution.repository.SalesReturnOrderRepository;
...
public class SalesReturnOrderManager extends ServiceEntityManager {
    ...
    public void setServiceEntityDAO() {
        ...
        super.setServiceEntityDAO(new JpaServiceEntityDAO(entityManager, salesReturnOrderDAO, this.getSeConfigureProxy()));
    }
