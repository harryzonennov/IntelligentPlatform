...
@Entity
@Table(name = "SalesContractActionNode", catalog = "sales")
public class SalesContractActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.SalesContractActionNode;
    ...
    public static final int DOC_ACTION_INPLAN = SystemDefDocActionCodeProxy.DOC_ACTION_INPROCESS;
    ...
    public static final String NODEINST_ACTION_INPLAN = "inPlanBy";

    public SalesContractActionNode() {
