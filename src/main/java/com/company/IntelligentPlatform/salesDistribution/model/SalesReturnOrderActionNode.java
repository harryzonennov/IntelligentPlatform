...
@Entity
@Table(name = "SalesReturnOrderActionNode", catalog = "sales")
public class SalesReturnOrderActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.SalesReturnOrderActionNode;
    ...
    public SalesReturnOrderActionNode() {
