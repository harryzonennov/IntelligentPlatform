...
import com.company.IntelligentPlatform.salesDistribution.model.SalesContractActionNode;
...
@Component
public class SalesContractSearchModel extends SEUIComModel {
    ...
    @BSearchFieldConfig(fieldName = "requireExecutionDate", nodeName = SalesContract.NODENAME, fieldType =
			BSearchFieldConfig.FIELDTYPE_LOW,
            seName = SalesContract.SENAME, nodeInstID = SalesContract.SENAME)
    protected Date requireExecutionDateLow;

    protected String requireExecutionDateStrLow;
    ...
    public String getRequireExecutionDateStrLow() {
        return requireExecutionDateStrLow;
    }

    public void setRequireExecutionDateStrLow(String requireExecutionDateStrLow) {
        this.requireExecutionDateStrLow = requireExecutionDateStrLow;
    }
