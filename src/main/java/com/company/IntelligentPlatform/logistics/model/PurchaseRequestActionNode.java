...
@Entity
@Table(name = "PurchaseRequestActionNode", catalog = "logistics")
public class PurchaseRequestActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.PurchaseRequestActionNode;
    ...
    public static final int DOC_ACTION_INPROCESS = PurchaseRequest.STATUS_INPROCESS;
    ...
    public PurchaseRequestActionNode() {
