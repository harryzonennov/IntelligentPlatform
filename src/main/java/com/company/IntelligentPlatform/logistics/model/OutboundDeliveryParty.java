...
@Entity
@Table(name = "OutboundDeliveryParty", catalog = "logistics")
public class OutboundDeliveryParty extends DocItemParty {

	public final static String NODENAME = IServiceModelConstants.OutboundDeliveryParty;
