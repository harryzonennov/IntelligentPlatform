...
@Entity
@Table(name = "InboundDeliveryParty", catalog = "logistics")
public class InboundDeliveryParty extends DocItemParty {

	public final static String NODENAME = IServiceModelConstants.InboundDeliveryParty;
