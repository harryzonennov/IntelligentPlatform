...
@Entity
@Table(name = "InquiryActionNode", catalog = "logistics")
public class InquiryActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.InquiryActionNode;
