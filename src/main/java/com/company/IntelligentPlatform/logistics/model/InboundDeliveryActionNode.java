...
@Entity
@Table(name = "InboundDeliveryActionNode", catalog = "logistics")
public class InboundDeliveryActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.InboundDeliveryActionNode;
    ...
    public InboundDeliveryActionNode() {
