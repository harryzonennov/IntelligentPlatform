...
@Entity
@Table(name = "InventoryCheckOrderActionNode", catalog = "logistics")
public class InventoryCheckOrderActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.InventoryCheckOrderActionNode;
    ...
    public static final int DOC_ACTION_START_CHECK = SystemDefDocActionCodeProxy.DOC_ACTION_INPROCESS;
    ...
    public InventoryCheckOrderActionNode() {
