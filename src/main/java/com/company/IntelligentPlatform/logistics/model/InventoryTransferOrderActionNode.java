...
@Entity
@Table(name = "InventoryTransferOrderActionNode", catalog = "logistics")
public class InventoryTransferOrderActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.InventoryTransferOrderActionNode;
    ...
    public static final int DOC_ACTION_TRANSFER_DONE = SystemDefDocActionCodeProxy.DOC_ACTION_DELIVERY_DONE;
    ...
    public InventoryTransferOrderActionNode() {
