...
@Entity
@Table(name = "WarehouseStoreActionNode", catalog = "logistics")
public class WarehouseStoreActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.WarehouseStoreActionNode;

    public static final String SENAME = IServiceModelConstants.WarehouseStore;

    public static final int DOC_ACTION_INSTOCK = SystemDefDocActionCodeProxy.DOC_ACTION_INPROCESS;
    ...
    public static final String NODEINST_ACTION_INSTOCK = SystemDefDocActionCodeProxy.NODEINST_ACTION_INPROCESS;
    ...
    public WarehouseStoreActionNode() {
