...
public class QualityInspectPropertyItemUIModel extends SEUIComModel {
	...
	protected String propCheckStatusValue;
	...
	public double getCriHighValueDouble() {
		return this.criHighValueDouble;
	}
	...
	public double getCriCenterValueDouble() {
		return this.criCenterValueDouble;
	}
	...
	public double getCriOffSetValueDouble() {
		return this.criOffSetValueDouble;
	}
	...
	public String getPropCheckStatusValue() {
		return propCheckStatusValue;
	}

	public void setPropCheckStatusValue(String propCheckStatusValue) {
		this.propCheckStatusValue = propCheckStatusValue;
	}
