...
public class WasteProcessMaterialItemSearchModel extends SEUIComModel {
	...
	@BSearchGroupConfig(groupInstId = WasteProcessOrderActionNode.NODEINST_ACTION_APPROVE)
	protected DocActionNodeSearchModel submittedBy;

	@BSearchGroupConfig(groupInstId = WasteProcessOrderActionNode.NODEINST_ACTION_APPROVE)
	protected DocActionNodeSearchModel approvedBy;

	@BSearchGroupConfig(groupInstId = WasteProcessOrderActionNode.NODEINST_ACTION_DELIVERY_DONE)
	protected DocActionNodeSearchModel deliveryDoneBy;

	@BSearchFieldConfig(fieldName = "itemStatus", nodeName = WasteProcessMaterialItem.NODENAME, seName =
			WasteProcessMaterialItem.SENAME,
			nodeInstID = WasteProcessMaterialItem.NODENAME)
