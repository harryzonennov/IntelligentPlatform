...
public class OutboundDeliveryMessageHelper extends ServiceMessageHelper {
	...
	public static final String messageResourceName = "OutboundDeliveryMessage";
	
	public static final int COMMENT_APPROVE_TITLE = 1;
	
	public static final int COMMENT_APPROVE_CONTENT = 2;
	
	public static final int COMMENT_RECORDOUTBOUND_TITLE = 3;

	public static final int COMMENT_RECORDOUTBOUND_CONTENT = 4;
	...
	public String getMessage(int errorCode)
		...
		try {
			String path = OutboundDeliveryMessageHelper.class.getResource("")
					.getPath();
