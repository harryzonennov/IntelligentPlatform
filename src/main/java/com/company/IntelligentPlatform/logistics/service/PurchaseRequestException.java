...
public class PurchaseRequestException extends ServiceEntityException {
	...
	public PurchaseRequestException(int errorCode) {
		super(errorCode);
		try {
			this.errorMessage = ServiceExceptionHelper.getErrorMessage(
					PurchaseRequestException.class, errorCode);
	...
	public PurchaseRequestException(int errorCode, Object var) {
		super(errorCode);
		try {
	...
	public PurchaseRequestException(int type, String var1, String var2) {
		super(type);
		try {
			String errorMesTemplate = ServiceExceptionHelper.getErrorMessage(
					PurchaseRequestException.class, type) ;
