...
@Service
public class OutboundDeliveryStorageFeeProxy implements
		IFinanceAccountValueProxy {

	@Autowired
	OutboundDeliveryManager outboundDeliveryManager;

	@Override
	public double getAccountValue(String baseUUID, String client)
		...
		try {
			...
			return outboundDelivery.getGrossStorageFee();
		} catch (ServiceEntityConfigureException e) {
			throw new FinanceAccountValueProxyException(
					FinanceAccountValueProxyException.SYSTEM_ERROR);
		}
