...
@Service
public class WarehouseStoreItemExcelHelper extends DocMatItemExcelHandler {
    ...
    public List<FieldNameUnit> getDefFieldNameList() {
        ...
        List<FieldNameUnit> fieldNameList = new ArrayList<>(basicFieldNameList);
    ...
    public Class<?> getExcelModelClass() {
        return WarehouseStoreItemUIModel.class;
    }
