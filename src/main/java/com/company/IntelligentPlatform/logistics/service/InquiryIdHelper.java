...
@Service
public class InquiryIdHelper extends ServiceDefaultIdGenerateHelper {

	public static final String ID_PREFIX = "XJD";

	public static final String TABLE_NAME = Inquiry.SENAME;
