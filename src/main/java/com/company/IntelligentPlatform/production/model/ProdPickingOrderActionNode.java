...
@Entity
@Table(name = "ProdPickingOrderActionNode", catalog = "production")
public class ProdPickingOrderActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.ProdPickingOrderActionNode;
    ...
    public ProdPickingOrderActionNode() {
