...
@Entity
@Table(name = "ProductionOrderActionNode", catalog = "production")
public class ProductionOrderActionNode extends DocActionNode {

    public static final String NODENAME = IServiceModelConstants.ProductionOrderActionNode;
    ...
    public static final int DOC_ACTION_FINISHED = SystemDefDocActionCodeProxy.DOC_ACTION_DELIVERY_DONE;
    ...
    public ProductionOrderActionNode() {
