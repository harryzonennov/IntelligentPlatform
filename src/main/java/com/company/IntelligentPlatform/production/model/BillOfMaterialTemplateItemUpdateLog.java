...
@Entity
@Table(name = "BillOfMaterialTemplateItemUpdateLog", catalog = "production")
public class BillOfMaterialTemplateItemUpdateLog extends ServiceEntityNode {

	public final static String NODENAME = IServiceModelConstants.BillOfMaterialTemplateItemUpdateLog;
	...
	public BillOfMaterialTemplateItemUpdateLog() {
