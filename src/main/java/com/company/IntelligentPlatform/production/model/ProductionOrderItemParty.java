...
@Entity
@Table(name = "ProductionOrderItemParty", catalog = "production")
public class ProductionOrderItemParty extends DocInvolveParty {

	public static final String NODENAME = IServiceModelConstants.ProductionOrderItemParty;
	...
	public ProductionOrderItemParty() {
