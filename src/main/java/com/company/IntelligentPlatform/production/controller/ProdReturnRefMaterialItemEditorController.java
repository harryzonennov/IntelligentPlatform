...
@Scope("session")
@Controller(value = "prodReturnRefMaterialItemEditorController")
@RequestMapping(value = "/prodReturnRefMaterialItem")
public class ProdReturnRefMaterialItemEditorController extends
		SEEditorController {
	...
	public ServiceBasicUtilityController.ServiceUIModelRequest getServiceUIModelRequest() {
		return new ServiceBasicUtilityController.ServiceUIModelRequest(
				...
				ProdPickingRefMaterialItemServiceModel.class, AOID_RESOURCE,
				ProdPickingRefMaterialItem.NODENAME, ProdPickingRefMaterialItem.SENAME, prodPickingRefMaterialItemServiceUIModelExtension,
	...
	public @ResponseBody String loadFromProdOrderItemService(String baseUUID) {
		try {
			...
			List<ServiceEntityNode> prodPickingRefMaterialItemList = prodPickingOrderManager
					.getEntityNodeListByKey(baseUUID,
							"refProdOrderItemUUID",
							ProdPickingRefMaterialItem.NODENAME,
							logonUser.getClient(), null);
	...
	public ProdPickingRefMaterialItemUIModel refreshLoadUIModel(String uuid,
			String acId, LogonInfo logonInfo) throws ServiceEntityConfigureException,
			ServiceModuleProxyException, LogonInfoException, AuthorizationException {
		ProdPickingRefMaterialItem prodPickingRefMaterialItem = (ProdPickingRefMaterialItem) prodPickingOrderManager
		...
		ProdPickingRefMaterialItemUIModel prodPickingRefMaterialItemUIModel = (ProdPickingRefMaterialItemUIModel) prodPickingOrderManager
				.genUIModelFromUIModelExtension(
						...
						prodPickingRefMaterialItemServiceUIModelExtension
								.genUIModelExtensionUnion().get(0), 
						prodPickingRefMaterialItem, logonActionController.getLogonInfo(), null);
	...
	public @ResponseBody String loadModuleEditService(String uuid) {
		try {
			...
			return ServiceJSONParser.generateSimpleErrorJSON(e.getMessage());
		} catch (ServiceModuleProxyException | ProductionDataException e) {
			return ServiceJSONParser.generateSimpleErrorJSON(e
					.getErrorMessage());
		}
	}
		...
		try {
			...
			List<ServiceDocumentExtendUIModel> docFlowList = serviceDocumentComProxy
					.getDocFlowList(prodPickingRefMaterialItem, 
							prodPickingOrderManager, ISystemActionCode.ACID_VIEW, logonActionController.getLogonInfo());
