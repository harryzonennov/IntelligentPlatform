...
@Service
public class ProdJobOrderIdHelper extends ServiceDefaultIdGenerateHelper {

	public static final String ID_PREFIX = "PJOB";

	public static final String TABLE_NAME = "ProdJobOrder";
