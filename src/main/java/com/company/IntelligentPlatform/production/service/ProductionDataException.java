...
public class ProductionDataException extends ServiceEntityException {
	...
	public static final int PARA_NO_PRODPROCSS = 3;
	
	public static final int PARA_NO_COSTCENTER = 4;
	
	public static final int PARA_NO_MATERIALSKU = 5;
	
	public static final int PARA_NO_PROCESSROUTE = 6;
	
	public static final int PARA_NO_DATA = 7;

	public ProductionDataException(int errorCode) {
		super(errorCode);
		try {
			this.errorMessage = ServiceExceptionHelper.getErrorMessage(
					ProductionDataException.class, errorCode);
	...
	public ProductionDataException(int errorCode, Object var) {
		super(errorCode);
		try {
	...
	public ProductionDataException(int type, String var1, String var2) {
		super(type);
		try {
			String errorMesTemplate = ServiceExceptionHelper.getErrorMessage(
					ProductionDataException.class, type) ;
