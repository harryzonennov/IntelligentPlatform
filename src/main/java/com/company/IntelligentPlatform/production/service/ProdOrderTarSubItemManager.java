...
public class ProdOrderTarSubItemManager {
	...
	public List<PageHeaderModel> getPageHeaderModelList(SimpleSEJSONRequest request, String client)
		...
		docPageHeaderInputPara.setGenBaseModelList(new DocPageHeaderModelProxy.GenBaseModelList<ProdOrderTargetMatItem>() {
			@Override
			public List<com.company.IntelligentPlatform.platform.controller.PageHeaderModel> execute(ProdOrderTargetMatItem prodOrderTargetMatItem) throws ServiceEntityConfigureException {
		...
		docPageHeaderInputPara.setGenHomePageModel(new DocPageHeaderModelProxy.GenHomePageModel<ProdOrderTarSubItem>() {
			@Override
			public com.company.IntelligentPlatform.platform.controller.PageHeaderModel execute(ProdOrderTarSubItem prodOrderTarSubItem, com.company.IntelligentPlatform.platform.controller.PageHeaderModel pageHeaderModel) throws ServiceEntityConfigureException {
