...
import com.company.IntelligentPlatform.platform.service.MessageTemplateHandler;
import com.company.IntelligentPlatform.platform.service.MessageTemplateServiceModel;
...
@Service
public class ProdOrderPickingLackInPlanHandler extends MessageTemplateHandler {
    ...
    protected Logger logger = LoggerFactory.getLogger(ProdOrderPickingLackInPlanHandler.class);
    ...
    public List<ServiceEntityNode> postProcessSEDataList(MessageTemplateServiceModel messageTemplateServiceModel,
        ...
        for(ServiceEntityNode seNode: rawSEList){
            ...
            try {
                List<String> warehouseUUIDList = productionOrderManager.getWarehouseUUIDList(productionOrderItem.getParentNodeUUID(),
                ...
                if(productionOrderItem.getLackInPlanAmount() > 0){
