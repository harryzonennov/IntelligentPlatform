...
public class ProdOrderReportException extends ServiceEntityException {
	...
	public ProdOrderReportException(int errorCode) {
		super(errorCode);
		try {
			this.errorMessage = ServiceExceptionHelper.getErrorMessage(
					ProdOrderReportException.class, errorCode);
	...
	public ProdOrderReportException(int errorCode, Object var) {
		super(errorCode);
		try {
	...
	public ProdOrderReportException(int type, String var1, String var2) {
		super(type);
		try {
			String errorMesTemplate = ServiceExceptionHelper.getErrorMessage(
					ProdOrderReportException.class, type) ;
