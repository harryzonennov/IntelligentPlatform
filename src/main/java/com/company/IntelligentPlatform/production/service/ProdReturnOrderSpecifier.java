...
@Service
public class ProdReturnOrderSpecifier extends DocumentContentSpecifier<ProdPickingOrderServiceModel, ProdPickingOrder, ProdPickingRefMaterialItem> {
    ...
    public int getDocumentType() {
        return IDefDocumentResource.DOCUMENT_TYPE_PRODRETURNORDER;
    }
