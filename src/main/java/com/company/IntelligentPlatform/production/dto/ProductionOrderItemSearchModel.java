...
@Component
public class ProductionOrderItemSearchModel extends SEUIComModel {

	@BSearchFieldConfig(fieldName = "index", nodeName = ProductionOrderItem.NODENAME, seName = ProductionOrderItem.SENAME, nodeInstID = ProductionOrderItem.NODENAME, showOnUI = false)
	protected int index;

	@BSearchFieldConfig(fieldName = "uuid", nodeName = ProductionOrderItem.NODENAME, seName = ProductionOrderItem.SENAME
			, nodeInstID = ProductionOrderItem.NODENAME, showOnUI = false)
	protected String uuid;

	@BSearchFieldConfig(fieldName = "nodeName", nodeName = ProductionOrderItem.NODENAME, seName = ProductionOrderItem.SENAME
			, nodeInstID = ProductionOrderItem.NODENAME, showOnUI = false)
	protected String nodeName;

	@BSearchFieldConfig(fieldName = "parentNodeUUID", nodeName = ProductionOrderItem.NODENAME, seName = ProductionOrderItem.SENAME, nodeInstID = ProductionOrderItem.NODENAME, showOnUI = false)
	protected String parentNodeUUID;

	@BSearchFieldConfig(fieldName = "itemStatus", nodeName = ProductionOrderItem.NODENAME, seName = ProductionOrderItem.SENAME, nodeInstID = ProductionOrderItem.NODENAME)
	@ISEDropDownResourceMapping(resouceMapping = "ProductionOrderItemSearch_itemStatus", valueFieldName = "")
