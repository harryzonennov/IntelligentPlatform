...
public abstract class Account extends ServiceEntityNode {
	...
	public static final String SENAME = IServiceModelConstants.Account;
	...
	public static final String FIELD_taxNumber = "taxNumber";
	public static final String FIELD_bankAccount = "bankAccount";
	public static final String FIELD_depositBank = "depositBank";
