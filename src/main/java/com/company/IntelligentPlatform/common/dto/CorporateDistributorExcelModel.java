 ...
 *       tool
 */
public class CorporateDistributorExcelModel extends SEUIComModel {
	...
	protected String subDistributorType;
	...
	public String getSubDistributorType() {
		return subDistributorType;
	}

	public void setSubDistributorType(String subDistributorType) {
