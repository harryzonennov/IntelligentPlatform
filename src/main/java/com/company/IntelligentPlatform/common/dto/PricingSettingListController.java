...
@Scope("session")
@Controller(value = "pricingSettingListController")
@RequestMapping(value = "/pricingSetting")
public class PricingSettingListController extends SEListController {
	...
	protected List<PricingSettingUIModel> getModuleListCore(
			List<ServiceEntityNode> rawList)
			throws ServiceEntityInstallationException,
			ServiceEntityConfigureException, ServiceModuleProxyException {
		return serviceBasicUtilityController.convUIModuleList(PricingSettingUIModel.class, rawList,
				pricingSettingManager, pricingSettingServiceUIModelExtension);
	}
	...
	public @ResponseBody String loadModuleListService() {
		return serviceBasicUtilityController.searchModuleWrapper(AOID_RESOURCE, ISystemActionCode.ACID_LIST,
				...
				PricingSettingSearchModel.class, searchContext -> pricingSettingManager
	...
	public @ResponseBody String searchTableService(@RequestBody String request) {
		return serviceBasicUtilityController.searchTableServiceWrapper(AOID_RESOURCE, ISystemActionCode.ACID_LIST, request,
				this, PricingSettingSearchModel.class, searchContext -> pricingSettingManager
						.getSearchProxy().searchDocList(searchContext),  this::getModuleListCore);
	}
