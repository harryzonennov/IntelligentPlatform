...
@Service
public class FinanceDeptManagerPartyHandler implements IFlowTaskPartyHandler {
    ...
    protected Logger logger = LoggerFactory.getLogger(FinanceDeptManagerPartyHandler.class);

    public LogonUser getTargetUser(SerialLogonInfo serialLogonInfo) throws ServiceFlowException {
        return flowTaskPartyHandlerRepository.getTargetUserWrapper((orgUUID, logonInfo) -> logonUserOrgManager.getFinanceDeptManager(orgUUID, logonInfo), serialLogonInfo);
    }
}
