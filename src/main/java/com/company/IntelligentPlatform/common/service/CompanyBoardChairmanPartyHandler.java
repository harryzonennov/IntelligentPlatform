...
@Service
public class CompanyBoardChairmanPartyHandler implements IFlowTaskPartyHandler {
    ...
    protected Logger logger = LoggerFactory.getLogger(CompanyBoardChairmanPartyHandler.class);

    public LogonUser getTargetUser(SerialLogonInfo serialLogonInfo) throws ServiceFlowException {
        return flowTaskPartyHandlerRepository.getTargetUserWrapper((orgUUID, logonInfo) -> logonUserOrgManager.getCompanyBoardChairMan(orgUUID
                , logonInfo), serialLogonInfo);
    }
}
