...
public class ServiceComExecuteException extends ServiceEntityException {
	...
	public ServiceComExecuteException(int errorCode) {
		super(errorCode);
		try {
			this.errorMessage = ServiceExceptionHelper.getErrorMessage(
					ServiceComExecuteException.class, errorCode);
	...
	public ServiceComExecuteException(int errorCode, Object var) {
		super(errorCode);
		try {
	...
	public ServiceComExecuteException(int type, String var1, String var2) {
		super(type);
		try {
			String errorMesTemplate = ServiceExceptionHelper.getErrorMessage(
					ServiceComExecuteException.class, type) ;
