...
@Service
public class RegisteredProductIdHelper extends ServiceDefaultIdGenerateHelper{
	
	public static final String ID_PREFIX = "RGP";

	public static final String TABLE_NAME = RegisteredProduct.SENAME;
