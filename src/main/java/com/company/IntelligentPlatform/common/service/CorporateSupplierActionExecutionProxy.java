...
@Service
public class CorporateSupplierActionExecutionProxy
    ...
    public static final String PROPERTY_ACTIONCODE_FILE = "CorporateSupplier_actionCode";

    protected Logger logger = LoggerFactory.getLogger(CorporateSupplierActionExecutionProxy.class);
