...
@Service
public class PurchaseDeptManagerPartyHandler implements IFlowTaskPartyHandler {
    ...
    protected Logger logger = LoggerFactory.getLogger(PurchaseDeptManagerPartyHandler.class);

    public LogonUser getTargetUser(SerialLogonInfo serialLogonInfo) throws ServiceFlowException {
        return flowTaskPartyHandlerRepository.getTargetUserWrapper((orgUUID, logonInfo) -> logonUserOrgManager.getPurchaseDeptManager(orgUUID, logonInfo), serialLogonInfo);
    }
}
