...
/**
 * The General Service Entity Runtime Exception class
 * 
 * @author Zhang,Hang
 * 
 */
public class ServiceEntityRuntimeException extends RuntimeException implements IServiceEntityException{
	...
	public ServiceEntityRuntimeException(int errorCode) {
	...
	public String generateSimpleErrorJSON() {
		...
		String errorContent = "\"" + ServiceJSONDataConstants.ELE_ERROR_MSG
				...
				+ this.errorCode + ", \""
				+ ServiceJSONDataConstants.ELE_SUBERROR_CODE + "\":\""
				+ this.subErrorCode + "\"";
