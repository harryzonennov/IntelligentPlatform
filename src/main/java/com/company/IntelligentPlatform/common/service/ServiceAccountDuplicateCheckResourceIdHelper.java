...
@Service
public class ServiceAccountDuplicateCheckResourceIdHelper extends
		ServiceDefaultIdGenerateHelper {

	public static final String ID_PREFIX = "ADUP";

	public static final String TABLE_NAME = "ServiceAccountDuplicateCheckResource";
