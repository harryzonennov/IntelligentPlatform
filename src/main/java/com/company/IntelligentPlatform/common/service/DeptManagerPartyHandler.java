...
@Service
public class DeptManagerPartyHandler implements IFlowTaskPartyHandler {
    ...
    protected Logger logger = LoggerFactory.getLogger(DeptManagerPartyHandler.class);

    public LogonUser getTargetUser(SerialLogonInfo serialLogonInfo) throws ServiceFlowException {
        return flowTaskPartyHandlerRepository.getTargetUserWrapper((orgUUID, logonInfo) -> logonUserOrgManager.getDeptManager(orgUUID, logonInfo), serialLogonInfo);
    }
}
