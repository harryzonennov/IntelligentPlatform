...
public class SalesForcastException extends ServiceEntityException {
	...
	public SalesForcastException(int errorCode) {
		super(errorCode);
		try {
			this.errorMessage = ServiceExceptionHelper.getErrorMessage(
					SalesForcastException.class, errorCode);
	...
	public SalesForcastException(int errorCode, Object var) {
		super(errorCode);
		try {
	...
	public SalesForcastException(int type, String var1, String var2) {
		super(type);
		try {
			String errorMesTemplate = ServiceExceptionHelper.getErrorMessage(
					SalesForcastException.class, type) ;
