...
@Component
public class SalesReturnOrderSearchModel extends SEUIComModel {
	...
	@BSearchGroupConfig(groupInstId = SalesReturnOrderActionNode.NODEINST_ACTION_APPROVE)
	protected DocActionNodeSearchModel submittedBy;

	@BSearchGroupConfig(groupInstId = SalesReturnOrderActionNode.NODEINST_ACTION_APPROVE)
	protected DocActionNodeSearchModel approvedBy;

	@BSearchGroupConfig(groupInstId = SalesReturnOrderActionNode.NODEINST_ACTION_DELIVERY_DONE)
	...
	@BSearchFieldConfig(fieldName = "id", nodeName = SalesContract.NODENAME, seName = SalesContract.SENAME, nodeInstID =
			SalesContract.SENAME)
	protected String refDocumentId;

	@BSearchFieldConfig(fieldName = "name", nodeName = SalesContract.NODENAME, seName = SalesContract.SENAME,
			nodeInstID =
			SalesContract.SENAME)
	...
	@BSearchGroupConfig(groupInstId = "SalesContractDelieryDone")
	protected DocActionNodeSearchModel salesContractDeliveryDone;
	...
	public DocActionNodeSearchModel getSalesContractDeliveryDone() {
		return salesContractDeliveryDone;
	}

	public void setSalesContractDeliveryDone(DocActionNodeSearchModel salesContractDeliveryDone) {
		this.salesContractDeliveryDone = salesContractDeliveryDone;
	}
