...
@Service
public class FinAccountToRecordMessageHandler extends
	...
	public List<ServiceEntityNode> getRawTargetList(LogonInfo logonInfo)
		...
		finAccountSearchModel.setVerifyStatus(FinAccount.VERIFIED_DONE);
	...
	protected LogonUserMessage convertToMessage(ServiceEntityNode target)
		...
		logonUserMessage.setCategory(IMessageCategory.FINACC_TO_RECORD);
		logonUserMessage.setTargetID(finAccount.getId());
		logonUserMessage.setTargetUUID(finAccount.getUuid());
		logonUserMessage.setTargetStatus(finAccount.getRecordStatus());
		logonUserMessage
		...
		Map<Integer, String> recordStatusMap = serviceDropdownListHelper
				.getUIDropDownMap(FinAccountSearchModel.class, "recordStatus");
		logonUserMessage.setTargetStatusValue(recordStatusMap.get(finAccount
				.getRecordStatus()));
	...
	@Override
	public List<LogonUserMessage> generateMessageList(LogonInfo logonInfo,
			List<ServiceEntityNode> rawList) throws LogonInfoException,
	...
	public LogonUserMessageCategory generateCategoryTurnk(LogonInfo logonInfo)
		...
		logonUserMessageCategory.setCategory(IMessageCategory.FINACC_TO_RECORD);
	...
	public String getCategoryTitle() throws LogonUserMessageException {
		return getCategoryTitleByKey(IMessageCategory.FINACC_TO_RECORD);
	}
