...
@Service
public class OrganizationToFinSearchProxy extends ServiceSearchProxy {
	...
	public List<BSearchNodeComConfigure> getBasicItemSearchNodeConfigureList() throws SearchConfigureException {
		...
		searchNodeConfig0.setSeName(Organization.SENAME);
		searchNodeConfig0.setNodeName(Organization.NODENAME);
		searchNodeConfig0.setNodeInstID(Organization.SENAME);
		...
		searchNodeConfig1.setBaseNodeInstID(Organization.SENAME);
		searchNodeConfig1
